...
const allBuiltins = getAllBuiltins();
const BUILTIN_TYPES = [...allBuiltins.builtinTypes, ...allBuiltins.builtinAdtTypes];
const BUILTIN_FUNCTIONS = allBuiltins.builtinFunctions;
