...
const EXPECTED_BUILTINS = [
  // Built-in types
  'Field', 'Boolean', 'Uint', 'Bytes', 'Vector', 'Opaque', 'Void',
  // Built-in functions
  'map', 'fold', 'disclose', 'pad', 'slice', 'default',
  ...
  'ownPublicKey', 'createZswapInput', 'createZswapOutput',
  // Ledger ADT types
  'Counter', 'Set', 'Map', 'List', 'MerkleTree', 'HistoricMerkleTree', 'Cell', 'Kernel',
];
